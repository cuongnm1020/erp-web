...
/**
 * Form kit (shadcn) nối react-hook-form + zodResolver. Mọi form nghiệp vụ dùng bộ này để
 * lỗi 422 (applyServerErrors) và lỗi zod hiển thị cùng một kiểu.
 */
...
/** Luôn chiếm chỗ (min-h) để không layout shift khi lỗi xuất hiện. */
